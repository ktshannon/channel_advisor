...
class ListingServiceSoap < ::SOAP::RPC::Driver
  ...
  def initialize(endpoint_url = nil)
    ...
    self.mapping_registry = ::ChannelAdvisor::ListingServiceSOAP::DefaultMappingRegistry::EncodedRegistry
    self.literal_mapping_registry = ::ChannelAdvisor::ListingServiceSOAP::DefaultMappingRegistry::LiteralRegistry
    init_methods
  end
