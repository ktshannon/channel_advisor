...
class AdminServiceSoap < ::SOAP::RPC::Driver
  ...
  def initialize(endpoint_url = nil)
    ...
    self.mapping_registry = ::ChannelAdvisor::AdminServiceSOAP::DefaultMappingRegistry::EncodedRegistry
    self.literal_mapping_registry = ::ChannelAdvisor::AdminServiceSOAP::DefaultMappingRegistry::LiteralRegistry
    init_methods
  end
