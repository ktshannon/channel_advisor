...
class ShippingServiceSoap < ::SOAP::RPC::Driver
  ...
  def initialize(endpoint_url = nil)
    ...
    self.mapping_registry = ::ChannelAdvisor::ShippingServiceSOAP::DefaultMappingRegistry::EncodedRegistry
    self.literal_mapping_registry = ::ChannelAdvisor::ShippingServiceSOAP::DefaultMappingRegistry::LiteralRegistry
    init_methods
  end
