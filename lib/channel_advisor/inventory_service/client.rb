...
class InventoryServiceSoap < ::SOAP::RPC::Driver
  ...
  def initialize(endpoint_url = nil)
    ...
    self.mapping_registry = ::ChannelAdvisor::InventoryServiceSOAP::DefaultMappingRegistry::EncodedRegistry
    self.literal_mapping_registry = ::ChannelAdvisor::InventoryServiceSOAP::DefaultMappingRegistry::LiteralRegistry
    init_methods
  end
